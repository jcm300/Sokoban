...
instance Binary Picture where
    ...
    get = getInt >>= \i -> case i of
        ...
        8 -> get >>= return . Text
        9 -> get >>= \w -> get >>= \h -> get >>= \d -> get >>= \b -> return  (bitmapOfByteString w h (BitmapFormat TopToBottom PxRGBA) d b)
    ...
    readsPrec p0 r
      ...
      where
        ...
        mkBitMapData len bytes =
            ...
            in case bitmapOfByteString axis axis (BitmapFormat TopToBottom PxRGBA) bytes False of
