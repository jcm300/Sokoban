...
Copyright : José Carlos <zeclmartins@gmail.com>
...
correTestes :: IO ()
correTestes = do
    files1 <- getDirectoryContents "/home/jcm300/Sokoban/tests/T1"
    files2 <- getDirectoryContents "/home/jcm300/Sokoban/tests/T2"
    files3 <- getDirectoryContents "/home/jcm300/Sokoban/tests/T3"
    let inputs1 = map ("/home/jcm300/Sokoban/tests/T1/" ++) $ filter (isSuffixOf ".in") files1
    let inputs2 = map ("/home/jcm300/Sokoban/tests/T2/" ++) $ filter (isSuffixOf ".in") files2
    let inputs3 = map ("/home/jcm300/Sokoban/tests/T3/" ++) $ filter (isSuffixOf ".in") files3
