...
loadMapas :: IO ([String])
loadMapas = do
              mcp1 <- readFile "/home/jcm300/Sokoban/TarefaF/Niveis/nivel1"
              mcp2 <- readFile "/home/jcm300/Sokoban/TarefaF/Niveis/nivel2"
              mcp3 <- readFile "/home/jcm300/Sokoban/TarefaF/Niveis/nivel3"
              mcp4 <- readFile "/home/jcm300/Sokoban/TarefaF/Niveis/nivel4"
              mcp5 <- readFile "/home/jcm300/Sokoban/TarefaF/Niveis/nivel5"
...
desenhaMapa (boneco,caixa,parede,pf,caixaf) title ((xMapa,yMapa),((x,y):t),coords,n,ms,semCardTab,fon,nMapa) = Pictures [instrucoes,titulo,made,paredesCPf,figuraBoneco,score,sG]
    ...
    --made by
    made = Color black $ Pictures [Translate (((toEnum xMapa)/2)+32) (150) $ Scale (0.15) (0.15) $ Text "made by: Jose Carlos"]
